...
# When I do this, I don't know what I'm doing, so the core of this is copied from identify_images_v1.1.py,
#  an example script from SauceNAO.
...
try:
    ...
    config["Hydrus_Meta_Tags"] = {"enable": "1", "namespace": "hydrausnao", "hit": "hit", "miss": "miss",
                                  "no_result": "no_result", "service": "my tags"}
